...
const PRECO_PROJETOS = [
    ...
    {id:'ACO', nome:'Acompanhamento Técnico', un:'mês', preco:900.00, desc:'Visitas semanais no início da obra e quinzenais após estabilização, com visitas adicionais nas principais etapas executivas. Suporte por WhatsApp.'},
    ...
    {id:'PLS', nome:'PLS — Planilha de Medição Caixa (inclui acompanhamento)', un:'mês', preco:600.00, desc:'Planilha mensal da Caixa + visitas semanais/quinzenais de acompanhamento já inclusas, incluindo reprogramação caso necessário no decorrer da obra. Suporte por WhatsApp.'},
];

const ENTREGAS_PROJ = {
  'ARQ': { titulo: 'Projeto Arquitetônico',        itens: ['Plantas baixas de todos os pavimentos', 'Cortes e fachadas', 'Planta de situação e locação', 'Memorial descritivo', 'Perspectiva 3D ilustrativa', 'Arquivos digitais (PDF/DWG) entregues por e-mail/WhatsApp'] },
  'EST': { titulo: 'Projeto Estrutural',            itens: ['Cálculo estrutural completo', 'Pranchas de forma e locação', 'Detalhamento de armaduras', 'Memorial de cálculo', 'ART de projeto incluída', 'Arquivos digitais (PDF/DWG) entregues por e-mail/WhatsApp'] },
  'HID': { titulo: 'Projeto Hidrossanitário',       itens: ['Planta de água fria e quente', 'Planta de esgoto sanitário', 'Rede de águas pluviais', 'Detalhes isométricos', 'Lista de materiais', 'ART de projeto incluída', 'Arquivos digitais (PDF/DWG) entregues por e-mail/WhatsApp'] },
  'ELE': { titulo: 'Projeto Elétrico',              itens: ['Planta de iluminação e tomadas', 'Rede de comunicação (TV, internet)', 'Diagrama unifilar', 'Quadro de cargas e demandas', 'Lista de materiais', 'ART de projeto incluída', 'Arquivos digitais (PDF/DWG) entregues por e-mail/WhatsApp'] },
  'PREV':{ titulo: 'PPCI — Prevenção de Incêndio', itens: ['Projeto conforme normas CBMMG', 'Memória de cálculo', 'Pranchas técnicas', 'ART de projeto incluída', 'Arquivos digitais (PDF/DWG) entregues por e-mail/WhatsApp'] },
  'ACO': { titulo: 'Acompanhamento Técnico',        itens: ['Visitas semanais no início da obra (locação, definição de mão de obra, dúvidas iniciais)', 'Após estabilização: visitas a cada 15 dias', 'Visitas adicionais nas principais etapas executivas (mesmo fora do ciclo regular)', 'Suporte por WhatsApp durante toda a obra', 'Relatórios fotográficos de vistoria', 'Verificação de conformidade com projeto', 'Orientação técnica à equipe de obra'] },
  'GER': { titulo: 'Gerenciamento de Obra',         itens: ['Controle de cronograma físico-financeiro', 'Gestão de contratos e fornecedores', 'Controle de custos e medições', 'Relatórios mensais de andamento'] },
  'LAU': { titulo: 'Laudo de Engenharia',           itens: ['Vistoria técnica detalhada', 'Diagnóstico de patologias', 'Recomendações técnicas', 'Relatório com registro fotográfico', 'ART incluída', 'Documento digital (PDF) entregue por e-mail/WhatsApp'] },
  'VIS': { titulo: 'Vistoria Técnica',              itens: ['Vistoria in loco', 'Relatório técnico fotográfico', 'Recomendações de intervenção', 'Documento digital (PDF) entregue por e-mail/WhatsApp'] },
  'TOP': { titulo: 'Topografia',                    itens: ['Levantamento planialtimétrico', 'Georreferenciamento', 'Locação de divisas', 'Relatório técnico', 'ART incluída', 'Arquivos digitais (PDF/DWG) entregues por e-mail/WhatsApp'] },
  ...
  'PCI': { titulo: 'PCI — Planilha Caixa Inicial',  itens: ['Preenchimento da PCI (planilha inicial Caixa)', 'Memorial descritivo conforme padrão Caixa', 'Cronograma físico-financeiro inicial', 'Orçamento detalhado para análise', 'Documentação para liberação do financiamento', 'Arquivos digitais entregues por e-mail/WhatsApp'] },
  'PLS': { titulo: 'PLS — Planilha de Medição Caixa (com acompanhamento incluso)', itens: ['Visitas semanais no início da obra (locação, mão de obra, dúvidas iniciais)', 'Após estabilização: visitas a cada 15 dias e nas principais etapas executivas', 'Planilha de medição mensal da Caixa', 'Relatório fotográfico de execução', 'Verificação de conformidade com projeto', 'Reprogramação do cronograma quando necessário', 'Atualização de quantitativos executados', 'Acompanhamento até liberação de cada parcela', 'Suporte por WhatsApp durante toda a obra'] },
};
